...
namespace Client.Mvc.Services
{
  public class CategoriaService : ICategoriaService
  {
    ...
    private CategoriaViewModel categoriaVM = new();
    ...
    public async Task<IEnumerable<CategoriaViewModel>> GetCategorias()
    {
      ...
      {
        if (response.IsSuccessStatusCode) //true = StatusCode entre 200 e 299
        {
          var apiResponse = await response.Content.ReadAsStreamAsync(); //Serializa o conteúdo http em uma stream
